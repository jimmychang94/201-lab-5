...
function sumArray (testArray) { //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i = sum (i, 1)[0]) {
    theSum = sum (theSum, testArray[i])[0];
  }
...
function multiplyArray (testArray) { //eslint-disable-line
  var theProduct = 1;
  for (var i = 0; i < testArray.length; i = sum (i, 1)[0]) {
    theProduct = multiply (theProduct, testArray [i])[0];
  }
  var message = 'The numbers ' + testArray + ' have a product of '  + theProduct + '.';
  return [theProduct, message];
}
